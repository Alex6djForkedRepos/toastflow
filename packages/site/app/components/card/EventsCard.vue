  ...
  <Card>
        ...
        <SectionHeading text="Events (console.log)">
          ...
          >
            <span class="events-log-icon-badge">
              <UIcon name="i-tabler-terminal" class="size-4" />
            </span>
          </Button>
        </SectionHeading>
      </div>
    ...
    <div>
      ...
      <p class="text-[0.65rem] text-slate-400 dark:text-slate-500">
        At least one of title/description is required. Leave one empty if you
        want, but if both are blank we will auto-fill defaults (logging a
        warning).
      </p>
    </div>
  </Card>
