...
<template>
  ...
  >
    <div class="flex flex-wrap gap-2">
      <Button variant="primary" tooltip="Push a toast" @click="emit('push')">
        Push toast</Button
      >

      <Button
        variant="primary-muted"
        tooltip="Push five toasts"
        @click="emit('push-burst')"
      >
        Push 5
      </Button>
    ...
    <div class="flex flex-wrap gap-2">
      <Button
        ...
        :tooltip="
          queuePaused
            ? 'Resume processing queued toasts'
      ...
      <Button
        variant="outline"
        tooltip="Reset playground config"
        @click="emit('reset')"
      >
        Reset config
      </Button>
